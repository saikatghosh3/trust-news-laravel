...
<section
   ...
   <div class="xl:hidden">
    <a class="hidden dark:block w-32 flex_center overflow-hidden" href="{{ __url('/') }}">
        <img class="pt-1" src="{{ app_setting()->footer_logo }}" alt="Brand logo dark" />
    </a>
    <a class="dark:hidden w-32 flex_center overflow-hidden" href="{{ __url('/') }}">
        <img class="pt-1" src="{{ app_setting()->logo }}" alt="Brand logo light" />
    </a>
</div>
