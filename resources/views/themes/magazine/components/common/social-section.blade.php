...
{{-- download button end  --}}
    ...
    {{-- <button 
        onclick="playSpeech()" 
        id="ttsButton" 
        class="w-[28px] h-[28px] md:w-[36px] md:h-[36px] xl:w-[42px] xl:h-[42px] flex justify-center items-center  text-white border border-blue-600 hover:bg-blue-700 transition-all duration-500 ease-in-out rounded-full">
        🔊
    </button> --}}
    ...
    onclick="stopSpeech()" 
    id="stopTtsButton" 
    class="w-6 h-6 xl:w-10 xl:h-10 flex justify-center items-center p-1 text-red-600 ring-1 ring-red-600 transition-all duration-500 ease-in-out hover:bg-red-600 hover:text-white rounded-none hidden">
    ⏹
</button>
